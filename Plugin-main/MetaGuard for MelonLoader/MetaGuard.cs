    ...
    public class MetaGuard : MelonMod {
        ...
        public override void OnApplicationStart() {
            ...
            */
            ...
            using (var tempStream = new MemoryStream((int)stream.Length)) {
                ...
                MetaGuardAssetBundle = AssetBundle.LoadFromMemory(tempStream.ToArray(), 0);
                MetaGuardAssetBundle.hideFlags |= HideFlags.DontUnloadUnusedAsset;
            }

            MetaGuardPrefab = (GameObject) MetaGuardAssetBundle.LoadAsset("Assets/MetaGuard.prefab", typeof(GameObject));
        ...
        public override void OnUpdate() {
            if (Input.GetKeyDown(KeyCode.T)) {
                ...
                VRUIMenuObject.transform.localScale = new Vector3(10f, 10f, 10f); 
                VRUIMenuObject.transform.position = MainCamera.transform.position + MainCamera.transform.forward * 25f;
